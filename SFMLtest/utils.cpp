...
string Utilities::wrapBoxText(const string& initialText, const Font& font, const RectangleShape& box) const {
	string wrappedText;
	string word;
	...
	while (iss >> word) {
		...
		// Else try continuing regularly but adding the word and if the wrappedText isn't empty add in empty spaces
		else {
